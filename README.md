...
| onTypingStart         | `function`    | `null`             | It is triggered when user has started typing. Passes arguments: `fieldElement: HTMLElement, formElement: HTMLElement, value: string`                |
| onTypingEnd           | `function`    | `null`             | It is triggered when user has finished typing. Passes arguments: `fieldElement: HTMLElement, formElement: HTMLElement, value: string`               |
| onChange              | `function`    | `null`             | It is triggered when user has changed field. Passes arguments: `fieldElement: HTMLElement, formElement: HTMLElement, value: string`                 |
...
| onAfterValidate       | `function`    | `null`             | It is triggered after field validation. Passes arguments: `fieldElement: HTMLElement, formElement: HTMLElement, validationResult: ValidationResult` |
...
| submit               | `function` | `null`  | Submit function. It is triggered when user submits form and after validation. Must return `SubmitResult` (can return `Promise`, so you can use AJAX). If error occurred returns `SubmitResult` with `false` and logs to console. Passes `formElement: HTMLElement, formData: FormData` |
| onAfterSubmit        | `function` | `null`  | It is triggered after submission.  Passes `submitResult: SubmitResult, formElement: HTMLElement`                                                                                                                                                                                       |
| onAfterSubmitSuccess | `function` | `null`  | It is triggered after submission and `submit` callback returned `SubmitResult` with `true` .  Passes `submitResultData: object, formElement: HTMLElement`                                                                                                                              |
| onAfterSubmitError   | `function` | `null`  | It is triggered after submission and `submit` callback returned `SubmitResult` with `false` .  Passes `submitResultData: object, formElement: HTMLElement`                                                                                                                             |
